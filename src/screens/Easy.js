...
class Easy extends Component {
        ...
        this.setState({userGuess: newState}, () => {
            ...
            if (!correctGuess) {
                ...
                this.setState({wrongGuess: [...this.state.wrongGuess, true]}, () => {
                    if (this.state.wrongGuess.length >= 7) {
    ...
    handlequit = () => {
        Alert.alert(
            'Pansy Out?',
            'Going back will cancel your current game',
            [
                {
                    text: 'Cancel',
                ...
                {text: 'Pansy Out', onPress: () => this.props.navigation.goBack()},
            ],
            {cancelable: false},
        );
    }
            ...
            <View style={styles.container}>
                <View style={styles.draw}>
                    ...
                    <View style={styles.backButton}>
                        <Button title={'Back'} onPress={() => this.handlequit()}/>
